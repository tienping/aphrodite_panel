...
const tableSetting = {
    ...
    partner: {
        ...
        fields: [
            ...
            { key: 'industry', label: 'industry', width: '15rem', align: 'center', type: 'string', doc: { description: 'Dropdown of different options such as F&B, bonquet, services' } },
            { key: 'url', label: 'url', width: '20rem', align: 'left', type: 'link', doc: { description: 'URL link to partner vendor official site (if any)' } },
            { key: 'status', label: 'Status', width: '10rem', align: 'center', type: 'string', doc: { description: 'Avtive or inactive entry' } },
        ],
    },
    pevent: {
        title: 'Partner Event',
        ...
        fields: [
            ...
            { key: 'tnc_text', label: 'TNC', width: '20rem', align: 'left', type: 'string', doc: { description: 'Terms and condition in html format' } },
            ...
            { key: 'limit_by_user', label: 'Limit', width: '7rem', align: 'center', type: 'string', doc: { description: 'Maximun number of which each user can redempt' } },
            ...
            { key: 'amount', label: 'Amount', width: '8rem', align: 'center', type: 'string', doc: { description: 'The cost of voucher under this promotion event' } },
    ...
    voucher: {
        ...
        fields: [
            ...
            { key: 'start_date', label: 'Start Date', width: '10rem', align: 'center', type: 'datetime', doc: { description: 'The date voucher can start use' } },
